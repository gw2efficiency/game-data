...
const GAME_DATA_MOUNT_SKINS: Array<GameDataMountSkin> = [
  ...
  { id: 650, name: 'Spineshell Roller Beetle', unlock_items: [101684] },
  ...
  { id: 704, name: 'Steamwork Skyscale', unlock_items: [103749] },
  { id: 706, name: 'Enchanted Warclaw', unlock_items: [103789] },
  { id: 712, name: 'Plush Tiger Warclaw', unlock_items: [104139] },
  { id: 724, name: 'Noxious Chameleon', unlock_items: [104239] },
  { id: 725, name: 'Bloodmoon Nian', unlock_items: [104239] },
  { id: 726, name: 'Treespirit Gecko', unlock_items: [104239] },
  { id: 727, name: 'Skyborne Stalker Tigris', unlock_items: [104239] },
  { id: 728, name: 'Dracodile Skyscale', unlock_items: [104239] },
  { id: 729, name: 'Blazing Noble', unlock_items: [104239] },
  { id: 730, name: 'Alluring Avialan', unlock_items: [104239] },
  { id: 731, name: 'Sand Souled Cuckoo', unlock_items: [104239] },
  { id: 732, name: 'Charged Canthan Raptor', unlock_items: [104239] },
  { id: 733, name: 'Blazing Wolf', unlock_items: [104239] },
  { id: 735, name: 'Bioluminescent Roller Beetle', unlock_items: [104239] },
  { id: 736, name: 'Aurora Blessed Owl Griffon', unlock_items: [104239] },
  { id: 737, name: 'Ring-Tailed Jackal', unlock_items: [104239] },
  { id: 738, name: 'Horned Cobra Skyscale', unlock_items: [104239] },
  { id: 739, name: 'Frigate Skimmer', unlock_items: [104239] },
  { id: 740, name: 'Star Blessed Caprine', unlock_items: [104239] },
  { id: 741, name: 'Wisteria Arborscale', unlock_items: [104504] },
  { id: 742, name: 'Scalefang Warclaw', unlock_items: [104615] },
  { id: 743, name: 'Panda Roller Beetle', unlock_items: [104670] },
  { id: 751, name: 'Enchanted Roller Beetle', unlock_items: [104760] },
  { id: 754, name: 'Shelled Skyscale', unlock_items: [105019] },
  { id: 755, name: 'Castoran Tentacled Skimmer', unlock_items: [105036] },
  { id: 761, name: 'Bearded Broadtail Raptor', unlock_items: [105254] },
  { id: 781, name: 'Vital Geode Wavehawk Skimmer', unlock_items: [106141] },
  { id: 782, name: 'Vulture Griffon', unlock_items: [106141] },
  { id: 784, name: 'Lithosol Skyscale', unlock_items: [106141] },
  { id: 785, name: 'Majestic Lancer Noble Skyscale', unlock_items: [106141] },
  { id: 787, name: 'Luminous Prehistoric Siege Turtle', unlock_items: [106141] },
  { id: 790, name: 'Luminous Springer', unlock_items: [106141] },
  { id: 792, name: 'Aurene\'s Prismatic Feathered Raptor', unlock_items: [106141] },
  { id: 793, name: 'Striped Brushtail Springer', unlock_items: [106141] },
  { id: 794, name: 'Primeval Skyscale', unlock_items: [106141] },
  { id: 795, name: 'Streaked Journeykin Warclaw', unlock_items: [106141] },
  { id: 797, name: 'Spotted Elder Vulpine Jackal', unlock_items: [106141] },
  { id: 798, name: 'Dracodile Raptor', unlock_items: [106141] },
  ...
  { id: 854, name: 'Ornate Gourd Skimmer', unlock_items: [109862] },
  // -- GENERATE-END --
]
